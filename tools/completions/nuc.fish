...
complete -c nuc      -l no-cache    -d 'Disable LLVM caches'
complete -c nuc      -l cache-stats -d 'Cache hit/miss counters'
complete -c nuc      -n '__fish_seen_subcommand_from clean scram' -l cache -d 'Remove compilation caches'
