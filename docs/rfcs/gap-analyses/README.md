...
12. **[Tensor / ML / Autodiff](Nucleor_Tensor_ML_Autodiff_Gap_Analysis_and_RFC_2026-05-04.md)** — ML-1 `nuc_attn_flash` ABI mismatch and ML-4 rectangular attention are closed on the current helper branch with direct cross-attention fixture coverage. Tensor rank-2 matmul/transpose/permute, ML-15 P2a int/bool tensor dtype surfaces, quantize FP8/grouped/decode surfaces, ML-8 NN Conv1D/Conv2D/depthwise forward/backward kernels, ML-9 NN normalization forward/backward, ML-10 causal/encoder-decoder transformer attention, ML-13 P1 XOR plus P2a GNN convergence coverage, and ML-14 Dense autodiff input-gradient bridge now have focused helper evidence. Remaining ML launch risk is broader SSM/transformer convergence, opaque-autodiff, and GPU depth, not the old flash-attention arity mismatch.
