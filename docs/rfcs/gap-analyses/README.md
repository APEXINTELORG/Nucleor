...
12. **[Tensor / ML / Autodiff](Nucleor_Tensor_ML_Autodiff_Gap_Analysis_and_RFC_2026-05-04.md)** — ML-1 `nuc_attn_flash` ABI mismatch (rod 6 args, C 7 args). Silent miscompute on every flash-attention call. Tensor rank-2 matmul/transpose/permute and quantize FP8/grouped/decode surfaces now have focused helper coverage; ML-1 remains the launch-blocker.
