...
13. **[Quantum Subsystem](Nucleor_Quantum_Subsystem_Gap_Analysis_and_RFC_2026-05-04.md)** — QM-7 Clifford rod coverage is partially closed; rotated surface-code d=3 and published weight-enumerator parity remain open.
