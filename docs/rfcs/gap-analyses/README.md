...
14. **[Robotics Control Stack](Nucleor_Robotics_Control_Stack_Gap_Analysis_and_RFC_2026-05-04.md)** — ROBO-14 Phase 1 end-to-end smoke coverage exists; ROBO-7 frame-typing safety still Phase A. Mars Climate Orbiter failure mode is live.
