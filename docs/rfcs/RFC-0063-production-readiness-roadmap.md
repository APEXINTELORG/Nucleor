...
- tools_suite raw file carries 532 fns; **252 are name-duplicates of s1**
- s1 carries 840 fns; same 252 duplicate the other direction
- duplicate categories after current refresh: 73 IDENTICAL, 163 SIG_MATCH_BODY_DIFFERS, 16 SIG_DIFFERS
