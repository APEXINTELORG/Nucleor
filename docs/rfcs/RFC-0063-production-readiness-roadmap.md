...
| 2.0.3a | Signature-audit pass — write `tools/audit_dup_fns.nr`, enumerate all duplicate fn names, categorize, and refresh `tools/audit_dup_fns_report.csv` after helper/cloud integration. **Current result after v0845 Wave 10 Queue 1A + Wave 11 Queue 1B refresh on the cloud Round-3 8M rebase:** 180 duplicates: 30 IDENTICAL (safe-delete candidates), 131 SIG_MATCH_BODY_DIFFERS (same signature, body review/replace), 19 SIG_DIFFERS (per-fn lift/adapter work). | DONE v0.8.323 — see `findings/promoted/2026-05-06-phase-2-0-3a-dup-fn-audit-results.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave1_v0838_2026-05-06.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave2_v0839_2026-05-06.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave3_v0840_2026-05-06.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave4_v0840_2026-05-06.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave5_v0840_2026-05-06.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave6_v0841_2026-05-06.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave7_v0842_2026-05-07.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave8_v0842_2026-05-07.md`, `findings/inbox/helper2_rfc0063_tools_suite_wave9_v0844_2026-05-07.md`, `findings/inbox/partner_lane1_1A_v0845_2026-05-07.md`, `findings/inbox/partner_lane1_1B_v0845_2026-05-07.md`, and the current CSV. |
| 2.0.3b | Wave 1/2/3/4/5/6/7/8/10 — delete/import IDENTICAL dups from tools_suite through the parser/tools-suite unification strategy. Audit-driven: every fn in this wave is byte-identical between files, so semantics should be preserved. Caveat: avoid duplicate-name import collisions by either batching the remaining waves in the same ship or pre-renaming legacy tools-suite versions via the `_tools_legacy` strategy noted in the finding. | PARTIAL v0838/v0839/v0840/v0841/v0842/v0845 — 231 IDENTICAL helpers moved into `compiler/nucleor_rfc0063_shared_wave1.nr`, imported by `compiler/nucleor_tools_suite.nr`, and removed from the raw tools-suite file while s1 remains canonical. Remaining IDENTICAL candidates: 30. |
| 2.0.3c | Wave 9+ — delete/import the `SIG_MATCH_BODY_DIFFERS` dups only after review. Wave 9 retired the first safe normalized-identical bucket: signatures match and executable text normalized identically, with differences limited to comments/formatting. Wave 11 Queue 1B retired a reviewed constructor/helper batch where the only executable delta was tools-suite `Vec::new()` versus s1 `Vec::with_capacity(...)`. Verify any future tools_suite-specific behavior in deleted bodies is either intentionally retired or carried forward. | PARTIAL v0844/v0845 — 19 normalized-identical body-diff helpers plus 13 constructor/helper allocation-shape helpers moved into `compiler/nucleor_rfc0063_shared_wave1.nr`; remaining SIG_MATCH_BODY_DIFFERS candidates: 131. |
...
- s1 carries 854 fns; same 180 duplicate the other direction
- duplicate categories after current refresh: 30 IDENTICAL, 131 SIG_MATCH_BODY_DIFFERS, 19 SIG_DIFFERS
- 279 tools-only fns (CLI dispatch, JSON formatting, ABI analysis, profiling, cache mgmt)
- 549 s1-only fns (codegen / lowering / IR emission / 30+ safety enforcements)
