...
- tools_suite raw file carries 613 fns; **334 are name-duplicates of s1**
- s1 carries 825 fns; same 334 duplicate the other direction
- duplicate categories after current refresh: 155 IDENTICAL, 163 SIG_MATCH_BODY_DIFFERS, 16 SIG_DIFFERS
- 279 tools-only fns (CLI dispatch, JSON formatting, ABI analysis, profiling, cache mgmt)
- 466 s1-only fns (codegen / lowering / IR emission / 30+ safety enforcements)
