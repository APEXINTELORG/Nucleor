...
- tools_suite raw file carries 593 fns; **314 are name-duplicates of s1**
- s1 carries 830 fns; same 314 duplicate the other direction
- duplicate categories after current refresh: 135 IDENTICAL, 163 SIG_MATCH_BODY_DIFFERS, 16 SIG_DIFFERS
- 279 tools-only fns (CLI dispatch, JSON formatting, ABI analysis, profiling, cache mgmt)
- 516 s1-only fns (codegen / lowering / IR emission / 30+ safety enforcements)
