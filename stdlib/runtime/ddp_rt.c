    ...
    long long terminal_cost_fp)
{
    ...
    double *f_xx        = (double *)malloc((size_t)n_x * n_x * n_x * sizeof(double));
    double *f_uu        = (double *)malloc((size_t)n_x * n_u * n_u * sizeof(double));
    double *f_ux        = (double *)malloc((size_t)n_x * n_u * n_x * sizeof(double));
